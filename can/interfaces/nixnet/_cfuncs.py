...
class XnetLibrary(object):
    ...
    def nx_create_session(
        ...
        return self._nx_create_session(
            database_name, cluster_name, list, interface, mode, session_ref
        )
    ...
    def nx_create_session_by_ref(
        ...
        return self._nx_create_session_by_ref(
            size_of_database_refs, database_refs, interface, mode, session_ref
        )
    ...
    def nx_get_property(
        ...
        return self._nx_get_property(
            session_ref, property_id, property_size, property_value
        )
    ...
    def nx_get_property_size(
        ...
        return self._nx_get_property_size(session_ref, property_id, property_size)
    ...
    def nx_get_sub_property(
        ...
        return self._nx_get_sub_property(
            session_ref, active_index, property_id, property_size, property_value
        )
    ...
    def nx_get_sub_property_size(
        ...
        return self._nx_get_sub_property_size(
            session_ref, active_index, property_id, property_size
        )
    ...
    def nx_read_frame(
        ...
        return self._nx_read_frame(
            session_ref, buffer, size_of_buffer, timeout, number_of_bytes_returned
        )
    ...
    def nx_read_state(
        ...
        return self._nx_read_state(
            session_ref, state_id, state_size, state_value, fault
        )
    ...
    def nx_write_frame(
        ...
        return self._nx_write_frame(session_ref, buffer, size_of_buffer, timeout)
    ...
    def nx_write_signal_single_point(
        ...
        return self._nx_write_signal_single_point(
            session_ref, value_buffer, size_of_value_buffer
        )
    ...
    def nx_write_state(
        ...
        return self._nx_write_state(session_ref, state_id, state_size, state_value)
    ...
    def nx_write_signal_waveform(
        ...
        return self._nx_write_signal_waveform(
            session_ref, timeout, value_buffer, size_of_value_buffer
        )
    ...
    def nx_blink(
        ...
        if self._nx_blink is None:
            with self._load_lock:
                ...
                cfunc.argtypes = [_ctypedefs.nxSessionRef_t, _ctypedefs.u32]
                cfunc.restype = _ctypedefs.nxStatus_t
                self._nx_blink = cfunc
        return self._nx_blink(interface_ref, modifier)
    ...
    def nx_clear(
        ...
        if self._nx_clear is None:
            with self._load_lock:
                ...
                cfunc.argtypes = [_ctypedefs.nxSessionRef_t]
                cfunc.restype = _ctypedefs.nxStatus_t
                self._nx_clear = cfunc
        return self._nx_clear(session_ref)
    ...
    def nx_connect_terminals(
        ...
        return self._nx_connect_terminals(session_ref, source, destination)
    ...
    def nx_disconnect_terminals(
        ...
        return self._nx_disconnect_terminals(session_ref, source, destination)
    ...
    def nx_flush(
        ...
        return self._nx_flush(session_ref)
    ...
    def nx_start(
        ...
        return self._nx_start(session_ref, scope)
    ...
    def nx_stop(
        ...
        if self._nx_stop is None:
            with self._load_lock:
                ...
                cfunc.restype = _ctypedefs.nxStatus_t
                self._nx_stop = cfunc
        return self._nx_stop(session_ref, scope)
    ...
    def nx_status_to_string(
        ...
        return self._nx_status_to_string(
            status, size_of_status_description, status_description
        )
    ...
    def nx_system_open(
        ...
        if self._nx_system_open is None:
            with self._load_lock:
                ...
                cfunc.argtypes = [ctypes.POINTER(_ctypedefs.nxSessionRef_t)]
                cfunc.restype = _ctypedefs.nxStatus_t
                self._nx_system_open = cfunc
        return self._nx_system_open(system_ref)
    ...
    def nx_system_close(
        ...
        return self._nx_system_close(system_ref)
    ...
    def nx_wait(
        ...
        if self._nx_wait is None:
            with self._load_lock:
                ...
                cfunc.restype = _ctypedefs.nxStatus_t
                self._nx_wait = cfunc
        return self._nx_wait(session_ref, condition, param_in, timeout, param_out)
    ...
    def nxdb_open_database(
        ...
        return self._nxdb_open_database(database_name, database_ref)
    ...
    def nxdb_close_database(
        ...
        if self._nxdb_close_database is None:
            with self._load_lock:
                ...
                cfunc.argtypes = [_ctypedefs.nxDatabaseRef_t, _ctypedefs.bool32]
                cfunc.restype = _ctypedefs.nxStatus_t
                self._nxdb_close_database = cfunc
        return self._nxdb_close_database(database_ref, close_all_refs)
    ...
    def nxdb_create_object(
        ...
        return self._nxdb_create_object(
            parent_object_ref, object_class, object_name, db_object_ref
        )
    ...
    def nxdb_delete_object(
        ...
        if self._nxdb_delete_object is None:
            with self._load_lock:
                ...
                cfunc.argtypes = [_ctypedefs.nxDatabaseRef_t]
                cfunc.restype = _ctypedefs.nxStatus_t
                self._nxdb_delete_object = cfunc
        return self._nxdb_delete_object(db_object_ref)
    ...
    def nxdb_save_database(
        ...
        if self._nxdb_save_database is None:
            with self._load_lock:
                ...
                cfunc.argtypes = [_ctypedefs.nxDatabaseRef_t, _ctypedefs.char_p]
                cfunc.restype = _ctypedefs.nxStatus_t
                self._nxdb_save_database = cfunc
        return self._nxdb_save_database(database_ref, db_filepath)
    ...
    def nxdb_get_property(
        ...
        return self._nxdb_get_property(
            db_object_ref, property_id, property_size, property_value
        )
    ...
    def nxdb_get_property_size(
        ...
        return self._nxdb_get_property_size(db_object_ref, property_id, property_size)
    ...
    def nxdb_get_dbc_attribute_size(
        ...
        return self._nxdb_get_dbc_attribute_size(
            db_object_ref, mode, attribute_name, attribute_text_size
        )
    ...
    def nxdb_add_alias(
        ...
        if self._nxdb_add_alias is None:
            with self._load_lock:
                ...
                cfunc.argtypes = [_ctypedefs.char_p, _ctypedefs.char_p, _ctypedefs.u32]
                cfunc.restype = _ctypedefs.nxStatus_t
    ...
    def nxdb_add_alias64(
        ...
        if self._nxdb_add_alias64 is None:
            with self._load_lock:
                ...
                cfunc.argtypes = [_ctypedefs.char_p, _ctypedefs.char_p, _ctypedefs.u64]
                cfunc.restype = _ctypedefs.nxStatus_t
    ...
    def nxdb_remove_alias(
        ...
        if self._nxdb_remove_alias is None:
            with self._load_lock:
                ...
                cfunc.argtypes = [_ctypedefs.char_p]
                cfunc.restype = _ctypedefs.nxStatus_t
                self._nxdb_remove_alias = cfunc
        return self._nxdb_remove_alias(database_alias)
    ...
    def nxdb_deploy(
        ...
        return self._nxdb_deploy(
            ip_address, database_alias, wait_for_complete, percent_complete
        )
    ...
    def nxdb_undeploy(
        ...
        if self._nxdb_undeploy is None:
            with self._load_lock:
                ...
                cfunc.argtypes = [_ctypedefs.char_p, _ctypedefs.char_p]
                cfunc.restype = _ctypedefs.nxStatus_t
                self._nxdb_undeploy = cfunc
        return self._nxdb_undeploy(ip_address, database_alias)
    ...
    def nxdb_get_database_list_sizes(
        ...
        return self._nxdb_get_database_list_sizes(
            ip_address, sizeof_alias_buffer, sizeof_filepath_buffer
        )
