...
NX_PROP_SESSION_INTF_BUS_ERR_TO_IN_STRM = (
    0x00000015 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
...
NX_PROP_SESSION_INTF_START_TRIG_TO_IN_STRM = (
    0x00000014 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_CAN_EXT_TCVR_CONFIG = (
    0x00000023 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
...
NX_PROP_SESSION_INTF_CAN_OUT_STRM_LIST_BY_ID = (
...
NX_PROP_SESSION_INTF_FLEX_RAY_ACC_START_RNG = (
    0x00000030 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_INTF_FLEX_RAY_ALW_HLT_CLK = (
    0x00000031 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_FLEX_RAY_ALW_PASS_ACT = (
    0x00000032 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_INTF_FLEX_RAY_AUTO_ASLP_WHN_STP = (
    0x0000003A | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_FLEX_RAY_CLST_DRIFT_DMP = (
    0x00000033 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_INTF_FLEX_RAY_COLDSTART = (
    0x00000034 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_FLEX_RAY_DEC_CORR = 0x00000035 | NX_CLASS_SESSION | NX_PRPTYPE_U32
NX_PROP_SESSION_INTF_FLEX_RAY_DELAY_COMP_A = (
    0x00000036 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_INTF_FLEX_RAY_DELAY_COMP_B = (
    0x00000037 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_INTF_FLEX_RAY_KEY_SLOT_ID = (
    0x00000038 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
...
NX_PROP_SESSION_INTF_FLEX_RAY_MAC_INIT_OFF_A = (
    0x00000043 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_INTF_FLEX_RAY_MAC_INIT_OFF_B = (
    0x00000044 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_INTF_FLEX_RAY_MIC_INIT_OFF_A = (
    0x00000045 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_INTF_FLEX_RAY_MIC_INIT_OFF_B = (
    0x00000046 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
...
NX_PROP_SESSION_INTF_FLEX_RAY_NULL_TO_IN_STRM = (
    0x00000049 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_FLEX_RAY_OFF_CORR = 0x00000058 | NX_CLASS_SESSION | NX_PRPTYPE_U32
NX_PROP_SESSION_INTF_FLEX_RAY_OFF_CORR_OUT = (
    0x00000050 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_INTF_FLEX_RAY_RATE_CORR = 0x00000059 | NX_CLASS_SESSION | NX_PRPTYPE_U32
NX_PROP_SESSION_INTF_FLEX_RAY_RATE_CORR_OUT = (
    0x00000052 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_INTF_FLEX_RAY_SAMP_PER_MICRO = (
    0x00000053 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_INTF_FLEX_RAY_SING_SLOT_EN = (
    0x00000054 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_FLEX_RAY_STATISTICS_EN = (
    0x0000005A | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_FLEX_RAY_SYM_TO_IN_STRM = (
    0x0000003D | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_FLEX_RAY_SYNC_CH_A_EVEN = (
    0x0000005B | NX_CLASS_SESSION | NX_PRPTYPE_1_DU32
)
NX_PROP_SESSION_INTF_FLEX_RAY_SYNC_CH_A_ODD = (
    0x0000005C | NX_CLASS_SESSION | NX_PRPTYPE_1_DU32
)
NX_PROP_SESSION_INTF_FLEX_RAY_SYNC_CH_B_EVEN = (
    0x0000005D | NX_CLASS_SESSION | NX_PRPTYPE_1_DU32
)
NX_PROP_SESSION_INTF_FLEX_RAY_SYNC_CH_B_ODD = (
    0x0000005E | NX_CLASS_SESSION | NX_PRPTYPE_1_DU32
)
NX_PROP_SESSION_INTF_FLEX_RAY_SYNC_STATUS = (
    0x0000005F | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
...
NX_PROP_SESSION_INTF_FLEX_RAY_WAKEUP_PTRN = (
    0x00000056 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_INTF_FLEX_RAY_SLEEP = 0x0000003B | NX_CLASS_SESSION | NX_PRPTYPE_U32
NX_PROP_SESSION_INTF_FLEX_RAY_CONNECTED_CHS = (
    0x0000003C | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
...
NX_PROP_SESSION_INTF_LIN_SCHED_NAMES = (
    0x00000075 | NX_CLASS_SESSION | NX_PRPTYPE_1_DSTRING
)
...
NX_PROP_SESSION_INTF_LIN_ALW_START_WO_BUS_PWR = (
    0x00000078 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_LINO_STR_SLV_RSP_LST_BY_NAD = (
    0x00000079 | NX_CLASS_SESSION | NX_PRPTYPE_1_DU32
)
NX_PROP_SESSION_INTF_LIN_NO_RESPONSE_TO_IN_STRM = (
    0x00000080 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_LIN_CHECKSUM_TO_IN_STRM = (
    0x00000081 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_SRC_TERM_START_TRIGGER = (
    0x00000090 | NX_CLASS_SESSION | NX_PRPTYPE_STRING
)
...
NX_PROP_SESSION_J1939_RESPONSE_TIME_TR_SD = (
    0x00000099 | NX_CLASS_SESSION | NX_PRPTYPE_F64
)
NX_PROP_SESSION_J1939_RESPONSE_TIME_TR_GD = (
    0x0000009A | NX_CLASS_SESSION | NX_PRPTYPE_F64
)
...
NX_PROP_SESSION_J1939_INCLUDE_DEST_ADDR_IN_PGN = (
    0x000000A5 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_CAN_EDGE_FILTER = 0x000000A2 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
NX_PROP_SESSION_INTF_CAN_TRANSMIT_PAUSE = (
    0x000000A3 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
NX_PROP_SESSION_INTF_CAN_DISABLE_PROT_EXCEPTION_HANDLING = (
    0x000000A4 | NX_CLASS_SESSION | NX_PRPTYPE_BOOL
)
...
NX_PROP_INTF_DONGLE_COMPATIBLE_REVISION = (
    0x0000000E | NX_CLASS_INTERFACE | NX_PRPTYPE_U32
)
NX_PROP_INTF_DONGLE_COMPATIBLE_FIRMWARE_VERSION = (
    0x0000000F | NX_CLASS_INTERFACE | NX_PRPTYPE_U32
)
...
NX_PROP_SESSION_SUB_SKIP_N_CYCLIC_FRAMES = (
    0x00000083 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_SUB_OUTPUT_QUEUE_UPDATE_FREQ = (
    0x00000084 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_SUB_LIN_TX_N_CORRUPTED_CHKSUMS = (
    0x00000085 | NX_CLASS_SESSION | NX_PRPTYPE_U32
)
NX_PROP_SESSION_SUB_J1939_ADDR_FILTER = (
    0x00000086 | NX_CLASS_SESSION | NX_PRPTYPE_STRING
)
...
NX_PROP_DATABASE_SHOW_INVALID_FROM_OPEN = (
    0x00000003 | NX_CLASS_DATABASE | NX_PRPTYPE_BOOL
)
...
NX_PROP_CLST_FLEX_RAY_MAX_WO_CLK_COR_FAT = (
    0x00000031 | NX_CLASS_CLUSTER | NX_PRPTYPE_U32
)
NX_PROP_CLST_FLEX_RAY_MAX_WO_CLK_COR_PAS = (
    0x00000032 | NX_CLASS_CLUSTER | NX_PRPTYPE_U32
)
...
NX_PROP_FRM_FLEX_RAY_IN_CYC_REP_CH_ASSIGNS = (
    0x00000032 | NX_CLASS_FRAME | NX_PRPTYPE_1_DU32
)
...
NX_PROP_SUBFRM_NAME_UNIQUE_TO_CLUSTER = (
    0x00000007 | NX_CLASS_SUBFRAME | NX_PRPTYPE_STRING
)
...
NX_PROP_LIN_SCHED_ENTRY_COLLISION_RES_SCHED = (
    0x00000001 | NX_CLASS_LIN_SCHED_ENTRY | NX_PRPTYPE_REF
)
NX_PROP_LIN_SCHED_ENTRY_DELAY = 0x00000002 | NX_CLASS_LIN_SCHED_ENTRY | NX_PRPTYPE_F64
NX_PROP_LIN_SCHED_ENTRY_EVENT_ID = (
    0x00000003 | NX_CLASS_LIN_SCHED_ENTRY | NX_PRPTYPE_U32
)
NX_PROP_LIN_SCHED_ENTRY_FRAMES = (
    0x00000004 | NX_CLASS_LIN_SCHED_ENTRY | NX_PRPTYPE_1_DREF
)
NX_PROP_LIN_SCHED_ENTRY_NAME = 0x00000006 | NX_CLASS_LIN_SCHED_ENTRY | NX_PRPTYPE_STRING
NX_PROP_LIN_SCHED_ENTRY_NAME_UNIQUE_TO_CLUSTER = (
    0x00000008 | NX_CLASS_LIN_SCHED_ENTRY | NX_PRPTYPE_STRING
)
...
NX_PROP_LIN_SCHED_ENTRY_NC_FF_DATA_BYTES = (
    0x00000009 | NX_CLASS_LIN_SCHED_ENTRY | NX_PRPTYPE_1_DU8
)
...
NX_STATE_LIN_DIAGNOSTIC_SCHEDULE_CHANGE = (
    0x00000083 | NX_CLASS_INTERFACE | NX_PRPTYPE_U32
)
