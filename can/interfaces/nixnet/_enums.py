...
class Err(enum.Enum):
    ...
    UNCONNECTED_SYNCHRONIZATION_SOURCE = (
        _cconsts.NX_ERR_UNCONNECTED_SYNCHRONIZATION_SOURCE
    )
    ...
    # in use.
    CONNECTED_SYNCHRONIZATION_TERMINAL = (
        _cconsts.NX_ERR_CONNECTED_SYNCHRONIZATION_TERMINAL
    )
    ...
    # Connect Terminals.
    INVALID_SYNCHRONIZATION_DESTINATION = (
        _cconsts.NX_ERR_INVALID_SYNCHRONIZATION_DESTINATION
    )
    ...
    INVALID_SYNCHRONIZATION_COMBINATION = (
        _cconsts.NX_ERR_INVALID_SYNCHRONIZATION_COMBINATION
    )
    ...
    SESSION_TYPE_FRAME_INCOMPATIBILITY = (
        _cconsts.NX_ERR_SESSION_TYPE_FRAME_INCOMPATIBILITY
    )
    ...
    NOT_ENOUGH_MESSAGE_RAM_FOR_OBJECT = (
        _cconsts.NX_ERR_NOT_ENOUGH_MESSAGE_RAM_FOR_OBJECT
    )
    ...
    BAD_SYNTAX_IN_DATABASE_OBJECT_NAME = (
        _cconsts.NX_ERR_BAD_SYNTAX_IN_DATABASE_OBJECT_NAME
    )
    ...
    STRM_OUT_TMG_LIN_SCHEDULER_CONFLICT = (
        _cconsts.NX_ERR_STRM_OUT_TMG_LIN_SCHEDULER_CONFLICT
    )
    ...
    SESSN_TYPE_LIN_INTF_PRS_INCOMPATIBLE = (
        _cconsts.NX_ERR_SESSN_TYPE_LIN_INTF_PRS_INCOMPATIBLE
    )
    ...
    INCOMPATIABLE_TRANSCEIVER_REVISION = (
        _cconsts.NX_ERR_INCOMPATIABLE_TRANSCEIVER_REVISION
    )
    ...
    J1939_CTS_NEXT_PCK_LARGER_TOTAL_PCK_NUM = (
        _cconsts.NX_ERR_J1939_CTS_NEXT_PCK_LARGER_TOTAL_PCK_NUM
    )
    ...
    J1939_ABORT_MSG_ACTIVE_CONNECTION = (
        _cconsts.NX_ERR_J1939_ABORT_MSG_ACTIVE_CONNECTION
    )
    ...
    J1939_ABORT_MSG_NOT_ENOUGH_SYS_RES = (
        _cconsts.NX_ERR_J1939_ABORT_MSG_NOT_ENOUGH_SYS_RES
    )
    ...
    # (for example, a comma).
    INVALID_CHAR_IN_DATABASE_FILEPATH = (
        _cconsts.NX_ERR_INVALID_CHAR_IN_DATABASE_FILEPATH
    )
...
class Warn(enum.Enum):
    ...
    DATABASE_IMPORT_FIBEX_NO_XNET_FILE = (
        _cconsts.NX_WARN_DATABASE_IMPORT_FIBEX_NO_XNET_FILE
    )
    ...
    DATABASE_IMPORT_FIBEX_NO_XNET_FILE_PLUS_WARNING = (
        _cconsts.NX_WARN_DATABASE_IMPORT_FIBEX_NO_XNET_FILE_PLUS_WARNING
    )
